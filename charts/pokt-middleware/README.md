...
A Helm for deploying the POKT QOS Service

## Maintainers

| Name | Email | Url |
| ---- | ------ | --- |
| GustavoBelfort |  | <https://github.com/GustavoBelfort/> |
...
| image.repository | string | `"pocketfoundation/pokt-middleware"` |  |
...
| serviceAccount.name | string | `"pokt-middleware"` |  |
| tolerations | list | `[]` |  |
